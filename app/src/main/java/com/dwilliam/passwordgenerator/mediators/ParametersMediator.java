package com.dwilliam.passwordgenerator.mediators;
...
public class ParametersMediator implements CompoundButton.OnCheckedChangeListener, View.OnClickListener, SeekBar.OnSeekBarChangeListener, CustomChooserView.DialogListener {
    ...
    private final View decrease;
    private final View increase;
    private final TextView textLength;
    private final SeekBar bar;

    private final RadioButton regular;
    private final RadioButton custom;

    private final SwitchCompat lower;
    private final SwitchCompat upper;
    private final SwitchCompat digit;
    private final SwitchCompat special;

    private final CustomChooserView chooser;

    private final OnParametersChangeListener listener;

    private final boolean[] states;

    public ParametersMediator(AppCompatActivity context, String symbols, int length, boolean[] states, int posSymbols, View decrease, View increase, TextView textLength, SeekBar bar, RadioButton regular, RadioButton custom, SwitchCompat lower, SwitchCompat upper, SwitchCompat digit, SwitchCompat special, CustomChooserView chooser, OnParametersChangeListener listener) {
